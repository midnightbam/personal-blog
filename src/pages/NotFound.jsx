  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <footer className="border-t border-gray-200 py-6 bg-gray-50">
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 max-w-[1400px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <Link to="/" className="text-gray-600 hover:text-gray-900 text-sm underline">
            Home page
          </Link>
        </div>
      </footer>
