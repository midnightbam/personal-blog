      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-12 py-3 sm:py-4">
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-4 pt-4 border-t border-gray-200 space-y-3">
            <button className="w-full px-6 py-3 text-base bg-white text-gray-900 font-medium rounded-full border-2 border-gray-900 hover:bg-gray-100 transition-colors">
              Log in
            </button>
            <button className="w-full px-6 py-3 text-base bg-[#26231E] text-white font-medium rounded-full hover:bg-[#75716B] transition-colors">
              Sign up
            </button>
          </div>
        )}
