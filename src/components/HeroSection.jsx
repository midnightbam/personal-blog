      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-12 max-w-[1400px] mx-auto w-full">
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-10 lg:gap-6 xl:gap-10 items-center justify-center">
          ...
          <div className="flex-shrink-0 text-center lg:text-right lg:pr-4 xl:pr-6 w-full lg:w-auto lg:max-w-[280px] xl:max-w-[350px]">
            ...
            <p className="text-sm sm:text-base lg:text-sm xl:text-base text-gray-600 leading-relaxed px-4 sm:px-0">
          ...
          <div className="flex-shrink-0 w-full lg:w-auto lg:max-w-[280px] xl:max-w-[350px] lg:pl-4 xl:pl-6 px-4 sm:px-6 lg:px-0">
            <p className="text-xs sm:text-sm text-gray-500 mb-1.5 lg:mb-2">—Author</p>
            <h2 className="text-xl sm:text-2xl lg:text-xl xl:text-2xl font-bold text-gray-900 mb-2.5 sm:mb-3 lg:mb-3">Thompson P.</h2>
            <p className="text-sm sm:text-base lg:text-sm xl:text-base text-gray-600 leading-relaxed mb-2.5 sm:mb-3 lg:mb-3">
              I am a pet enthusiast and freelance writer who specializes in animal behavior and care. With a deep love for cats, I enjoy sharing insights on feline companionship and wellness.
            </p>
            <p className="text-sm sm:text-base lg:text-sm xl:text-base text-gray-600 leading-relaxed">
